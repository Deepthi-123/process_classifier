...
dataset = pandas.read_csv('/home/ipa325/topic_log/20170515/20170515-09_07_02_wrench.log', names = names, delim_whitespace = False)#read the final_wrench.log file
dataset.to_csv('/home/ipa325/wrench_test_check55.log',index=True, sep='\t', mode='w') #and write to final_wrench_mod. Dataframe created for ease of data manip
...
datset = pandas.read_csv('/home/ipa325/topic_log/20170421/20170421-11_19_17_Jq.log', names = names_, delim_whitespace = False) #read and write jacobian file
datset.to_csv('/home/ipa325/jacob_mod_true44.log',index=True, sep='\t', mode='w')
...
dataset1 = pandas.read_csv('/home/ipa325/topic_log/20170421/20170421-11_19_17_eigenforce3d.log', names = names1) 
dataset1.to_csv('/home/ipa325/final_eig3d_this44.log', header=False, index=False, sep='\t', mode='w')
...
data_final = data_final[['f_x','f_y','f_z','t_x','t_y','t_z','jq01','jq02','jq03','jq04','jq05','jq06','jq11','jq12','jq13','jq14','jq15','jq16','jq21','jq22','jq23','jq24','jq25','jq26','jq31','jq32','jq33','jq34','jq35','jq36','jq41','jq42','jq43','jq44','jq45','jq46','jq51','jq52','jq53','jq54','jq55','jq56','x1','x2','x3','x4','x5','x6','time_x','eigen_force']]
...
data_final.to_csv('/home/ipa325/wrench_jacobian_prod44.log',index=True, sep='\t', mode='w')
axes = plt.gca()
axes.set_xlim([1100, 1500])
plt.plot(data_final['time_x'],data_final['x1'], 'r', label = 'tau1q')
plt.plot(data_final['time_x'],data_final['x2'], 'b', label = 'tau2q')
plt.plot(data_final['time_x'],data_final['x3'], 'g', label = 'tau3q')
plt.plot(data_final['time_x'],data_final['x4'], 'c', label = 'tau4q')
plt.plot(data_final['time_x'],data_final['x5'], 'm', label = 'tau5q')
plt.plot(data_final['time_x'],data_final['x6'], 'y', label = 'tau6q')
plt.plot(data_final['time_x'],data_final['eigen_force'], 'k', label = 'eigen force')
plt.legend(loc = 'best')
plt.xlabel('Time')
plt.ylabel('Eigen-Force and Joint Torques')
plt.title('Eigen-Force and Joint Torques vs time')
plt.show()
