...
dataset = pandas.read_csv('/home/deepthi/final_wrench.log', names = names, delim_whitespace = False)#read the final_wrench.log file
...
datan = pandas.read_csv('/home/deepthi/topic_log/_20170420/20170420-10_08_01_status.log', names = names_n, delim_whitespace = False)#read the final_wrench.log file
...
datset = pandas.read_csv('/home/deepthi/topic_log/_20170420/20170420-10_08_01_Jq.log', names = names_, delim_whitespace = False) #read and write jacobian file
datset.to_csv('/home/deepthi/jacob_mod_true.log',index=True, sep='\t', mode='w')
...
dataset1.to_csv('/home/deepthi/final_eig3d_this.log', header=False, index=False, sep='\t', mode='w')
...
data_final.to_csv('/home/deepthi/wrench_jacobian_prod.log',index=True, sep=',', mode='w')
#print data_final
...
dat_check_fin.to_csv('/home/deepthi/check_eig_skill.log',index=True, sep='\t', mode='w')
...
data_final['eigen_force'].to_csv('/home/deepthi/eigen_forces_of_data_final.log', index = 'True', sep = '\t', mode = 'w')
