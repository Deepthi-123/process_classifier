...
dataset = pandas.read_csv('/home/ipa325/topic_log/20170421/20170421-11_19_17_wrench.log', names = names, delim_whitespace = False)#read the final_wrench.log file
dataset.to_csv('/home/ipa325/wrench_test_check44.log',index=True, sep='\t', mode='w') #and write to final_wrench_mod. Dataframe created for ease of data manip
