...
dataset = pandas.read_csv('/home/deepthi/topic_log/__20170420/20170420-10_33_02_wrench.log', names = names, delim_whitespace = False)#read the final_wrench.log file
dataset.to_csv('/home/deepthi/wrench_test_check_u3.log',index=True, sep='\t', mode='w') #and write to final_wrench_mod. Dataframe created for ease of data manip
...
dataset_ = dataset[1:].set_index('time_stamp')
#print dataset_
dataset_ = dataset_.apply(pandas.to_numeric)
names_n = ['eventtime', 'msg_stamp', 'symbols','status','skill']
datan = pandas.read_csv('/home/deepthi/topic_log/__20170420/20170420-10_33_02_status.log', names = names_n, delim_whitespace = False)#read the final_wrench.log file
datan.to_csv('/home/deepthi/status_test_check_u3.log',index=True, sep='\t', mode='w') #and write to final_wrench_mod. Dataframe created for ease of data manip
...
datset = pandas.read_csv('/home/deepthi/topic_log/__20170420/20170420-10_33_02_Jq.log', names = names_, delim_whitespace = False) #read and write jacobian file
datset.to_csv('/home/deepthi/jacob_mod_u3.log',index=True, sep='\t', mode='w')
...
dataset1 = pandas.read_csv('/home/deepthi/topic_log/__20170420/20170420-10_33_02_eigenforce3d.log', names = names1) 
dataset1.to_csv('/home/deepthi/final_eig3d_u3.log', header=False, index=False, sep='\t', mode='w')
...
#eig_max = eig_force.abs()
eig_max_ = pandas.Series((eig_force.map(float))+0.75)
eig_min = pandas.Series((eig_force.map(float))-0.75)
dl_list = {'f_x': f_x,
         'f_y': f_y,
         'f_z': f_z,
         't_x': t_x,
...
data_final = data_final[['f_x','f_y','f_z','t_x','t_y','t_z','jq01','jq02','jq03','jq04','jq05','jq06','jq11','jq12','jq13','jq14','jq15','jq16','jq21','jq22','jq23','jq24','jq25','jq26','jq31','jq32','jq33','jq34','jq35','jq36','jq41','jq42','jq43','jq44','jq45','jq46','jq51','jq52','jq53','jq54','jq55','jq56','x1','x2','x3','x4','x5','x6','time_x','eigen_force','eig_max','eig_min','skill']]
...
data_final['eig_max'].fillna(method = 'ffill', inplace = True)
data_final['eig_min'].fillna(method = 'ffill', inplace = True)
data_final.to_csv('/home/deepthi/wrench_jacobian_prod_u3.log',index=True, sep=',', mode='w')
#print data_final
p = data_final['time_x'].reset_index(drop = 'True')
q = data_final['eigen_force'].reset_index(drop = 'True')
r = data_final['skill'].reset_index(drop = 'True')
dd_ = {'time_check': p, 'eigen': q, 'skill': r}
dat_check = pandas.concat(dd_.values(), axis = 1, keys = dd_.keys())
dat_check_fin = dat_check.reset_index(drop= 'True')
dat_check_fin.to_csv('/home/deepthi/check_eig_skill_u3.log',index=True, sep='\t', mode='w')
print dat_check_fin
dict_skill = {'time': p, 'skill': r}
dat_skill = pandas.concat(dict_skill.values(), axis = 1, keys = dict_skill.keys())
dat_skill = dat_skill[['time', 'skill']]
#dat_skill.to_csv()
dat_check = dat_check[['time_check','eigen','skill']]
#print dat_check
axes = plt.gca()
fig, ax1 = plt.subplots()
ax1.plot(dat_check['eigen'],dat_check['skill'], 'rx')
ax1.set_ylim([26,31])
#ax1.set_xlim([600,615])
#ax1.set_xlim([])
#ax1.plot(data_final['time_x'],data_final['f_x'], 'r', label = 'force x')
#ax1.plot(data_final['time_x'],data_final['f_y'], 'b', label = 'force y')
#ax1.plot(data_final['time_x'],data_final['f_z'], 'g', label = 'forcez')
#ax2 = ax1.twinx()
#ax3 = ax1.twinx()
#ax3 = ax2.twiny()
#ax4 = ax3.twinx()
#ax5 = ax2.twiny()
#ax6 = ax5.twinx()
#a = ax3.plot(data_final['time_x'],data_final['skill'], 'r', label = 'skill for time 10:10:02')
#ax3.set_xlim([602.836,605.337])
#b = ax2.plot(data_final['time_x'],data_final['skill'], 'b', label = 'skill for time 10:12:43')
#ax2.set_xlim([763.367,765.843])
#e = ax5.plot(data_final['time_x'],data_final['skill'], 'g', label = 'skill for time 10:10:50')
#ax5.set_xlim([649.5,669.5])
#c = ax1.plot(data_final['time_x'],data_final['eigen_force'], 'r', label = 'eigen force for time 10:12:43')
#d = ax1.plot(data_final['time_x'],data_final['eig_max'], 'r', label = 'eigen force for time 10:12:40')
#e = ax1.plot(data_final['time_x'],data_final['eig_min'], 'b', label = 'eigen force for time 10:12:40')
#d = ax4.plot(data_final['time_x'],data_final['eigen_force'], 'y', label = 'eigen force for time 10:10:02')
#f = ax6.plot(data_final['time_x'],data_final['eigen_force'], 'm', label = 'eigen force for time 10:10:49')
ax1.legend(loc = 'upper right')
#ax2.legend(loc = 'lower right')
#ax3.legend(loc='lower left')
#ax3.legend(loc='best')
#ax4.legend(loc='upper left')
data_final['eigen_force'].to_csv('/home/deepthi/eigen_forces_of_data_final_u3.log', index = 'True', sep = '\t', mode = 'w')
#data_final['2017-04-20 10:12:43.000':'2017-04-20 10:12:46.000'].to_csv('/home/ipa325/squirtle.log',index=True, sep='\t', mode='w')
#plt.xlabel('Time')
#plt.ylabel('Eigen-Force and skills')
#plt.title('Eigen-Force vs time')
#plt.show()
#print data_final['eigen_force']
#print data_final['eig_max']
